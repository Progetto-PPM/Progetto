...
/* --------------------------------------------------------------------------- */
 ...
 const testiMercurio = [
    ...
    "1. Mercurio ha la più grande escursione termica di qualsiasi altro pianeta del Sistema Solare, passando da temperature diurne estremamente calde a notti estremamente fredde. Questo è dovuto alla mancanza di un'atmosfera in grado di trattenere la temperature, e sorpatutto alla sua vicinaza al Sole.\n\n 2. Ha un comportamento del tutto unico, impiega 59 giorni per ruotare attorno al suo asse e 88 per ruotare attorno al Sole. Si tratta di una sincronia perfetta, ogni 3 giri su se stesso fa 2 giri attorno al Sole."
];
...
/* --------------------------------------------------------------------------- */
 ...
 const testiVenere = [
    ...
    "1. Venere è il classico esempio di 'effetto serra fuori controllo'. L'anidride carboni intrappola il calore e impedisce il raffreddamento.\n\n2. Venere ruota in direzione opposta agli altri pianeti, una peculiarità che potrebbe essere il risultato di una collisione con un grande oggetto nelle prime fasi della sua formazione.\n\n3. È il corpo celeste più luminoso dopo il Sole e la Luna, visibile dalla Terra sia all'alba che al tramonto, rendendolo facilmente riconoscibile nel cielo.\n\n4. La pressione atmosfeira di Venere è talmente forte, che, paragonata alla Terra, è come se ci si trovasse ben 900 metri sotto il livello del Mare."
];
...
/* --------------------------------------------------------------------------- */
 const testiTerra = [
    ...
    "1. Il campo magnetico terrestre è generato dal movimento del nucleo esterno, questo campo protegge la Terra dai venti solai e crea le aurore polari.\n\n2. L'atmosfera terrestre permette il riscaldamento del pianeta trattenendo il calore del Sole, senza questo effetto, la temperatura sulla Terra sarebbe molto più bassa e meno favorevole alla vita.\n\n3. La Terra è il solo pianeta noto ad avere acqua in tutti e tre gli stati (solido, liquido e gassoso), essenziale per la vita e per i processi climatici.\n\n4. Il nostro pianeta ha un'atmosfera molto attiva, con sistemi metereologici complessi, stagioni, cicloni e venti. L'atmosfera varia continuamente, influenzata da vari fattori tra cui correnti oceaniche, riscaldamento solare e umidità."
];
...
/* --------------------------------------------------------------------------- */
 const testiMarte = [
    ...
    "1. Marte ha calotte polari costituie da ghiaccio d'acqua e ghiaccio secco. Sono stati scoperti inoltre segni di antichi letti di fiumi e possibili oceani, suggerendo che Marte potrebbe aver ospitato acqua liquida e un clima più caldo miliardi di anni fa.\n\n2. La superficie marziana è ricoperta di polvere fine e ricca di ossidi, che spesso causa enormi tempestre di polvere che possono ricoprire l'intero pianeta per settimane o mesi.\n\n3. Poichè l'atmosfera è molto sottile, Marte ha venti forti, ma la pressione bassa non permette di creare cicloni terrestri. Tuttavia, le tempeste di polvere rimangono eventi significativi e possono oscurare la superficie per lunghi periodi.\n\n4. Marte ha due piccoli satelliti, Phobos e Deimos, entramvi sono irregolari e sono probabilmente asteroidi catturati dalla sua gravità."
];
...
/* --------------------------------------------------------------------------- */
 const testiGiove = [
    ...
    "1. La Grande Macchia Rossa di Giove è una gigantesca tempesta anticiclonica, larga più di una volta e mezza il diametro della Terra, attiva da almeno 350 anni. Recenti osservazioni mostrano che potrebbe lentamente ridursi nel tempo\n\n2. Giove ospita numerose altre tempeste, alcune delle quali ruotano in senso opposto rispetto alle bande atmosferiche. Le bande di Giove sono guidate da venti ad altissima veloità, che possono superare i 500 km/h.\n\n3. Giove ha il campo magnetiche più forte tra i pianeti del Sistema SOlare, questo campo magnetico crea un'enorme magnetosfera che si estende per milioni di chilometri e protegge il pianeta da particelle cariche provenienti dal Sole. La magnetosfera di Giove ha un forte impatto anche sui suoi satelliti, creando intense radiazioni intorno a essi."
];
...
/* --------------------------------------------------------------------------- */
 const testiSaturno = [
    ...
    "1. Saturno emette più calore di quanto ne riceva dal Sole, questo è dovuto probabilmente alla compressione del nucleo e al fenomeno di pioggia di elio, in cui l'elio, precipitando dal cielo, libera molta energia.\n\n2. Saturno esercita una forza gravitazionale costante sui suoi anelli, impedendo che si disperano nello spazio.\n\n 3. La bassa densità di Saturno (inferiore all'acqua) significa che, ipoteticamente, galleggerebbe in un oceano d'acqua abbastanza grande da contenerlo."
];
...
/* --------------------------------------------------------------------------- */
 const testiUrano = [
    ...
    "1. L'inclinazione assiale estrema di Urano è probabilmente dovuta ad una collisone con un corpo planetario di dimensioni simili nei primi stadi della sua formazione, che avrebbe ribaltato il pianeta.\n\n2. A causa della sua inclinazione, ogni polo di Urano sperimenta 42 anni di luce continui, seguiti da 42 anni di buio.\n\n3. Urano emette meno calore rispetto ad altri giganti gassosi, e non si comprende completamente perchè sia così freddo rispetto ai suoi simili."
];
