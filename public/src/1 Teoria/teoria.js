...
/* --------------------------------------------------------------------------- */
 ...
 const testiMercurio = [
    ...
    "Mercurio ha la più grande escursione termica di qualsiasi altro pianeta del Sistema Solare, passando da temperature diurne estremamente calde a notti estremamente fredde. Questo è dovuto alla mancanza di un'atmosfera in grado di trattenere la temperature, e soprattutto alla sua vicinaza al Sole.\n\n Ha un comportamento del tutto unico, impiega 59 giorni per ruotare attorno al suo asse e 88 per ruotare attorno al Sole. Si tratta di una sincronia perfetta, ogni 3 giri su se stesso fa 2 giri attorno al Sole."
];
